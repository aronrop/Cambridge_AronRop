...
%\usepackage[labelfont=sc]{caption}%labels caption with small caps
...
%\usepackage{pdflscape} %dont load, for rendering landscape
...
\usepackage{upgreek}
\usepackage{array,multirow,layouts}
\usepackage{epstopdf}
...
%	\newcommand{\mynote}[1]{\todo[author=NT,size=\small,inline,color=green!40]{#1}}
%\else
%	\newcommand{\mynote}[1]{}
...
\makeatother
%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{ctable}% should be loaded after tikz. Gives propblems if loaded earlier
